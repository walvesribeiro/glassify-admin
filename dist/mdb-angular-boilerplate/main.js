...
/***/ "./node_modules/raw-loader/index.js!./src/app/admin/components/user-detail/user-detail.component.html":
/*!***************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/admin/components/user-detail/user-detail.component.html ***!
  \***************************************************************************************************/
...
/***/ "./node_modules/raw-loader/index.js!./src/app/admin/components/user/user.component.html":
/*!*************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/admin/components/user/user.component.html ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/admin/components/users-list/users-list.component.html":
/*!*************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/admin/components/users-list/users-list.component.html ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/admin/containers/admin/admin.component.html":
/*!***************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/admin/containers/admin/admin.component.html ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "<div class=\"container-fluid full-page-container\">\r\n  <div class=\"row h-100 justify-content-center align-items-center\">\r\n    <div class=\"col-lg-4 col-sm-8 animated fadeIn\">\r\n      <!-- Material form login -->\r\n      <mdb-card class=\"z-depth-2\">\r\n\r\n        <div class=\"text-center py-4\">\r\n          <h5>\r\n            <strong>Cadastrar</strong>\r\n          </h5>\r\n        </div>\r\n\r\n\r\n        <!--Card content-->\r\n        <mdb-card-body class=\"px-lg-5 pt-0\">\r\n          <div *ngIf=\"error$ | async as error\" class=\"alert alert-danger\" role=\"alert\">\r\n            {{ error }}\r\n          </div>\r\n          <!-- Form -->\r\n          <form [formGroup]=\"registerForm\" class=\"text-center\" style=\"color: #757575;\">\r\n\r\n            <!-- Username -->\r\n            <div class=\"md-form\">\r\n              <input type=\"text\" id=\"username\" class=\"form-control\" formControlName=\"username\" mdbInput>\r\n              <label for=\"username\">Nome de usuário</label>\r\n            </div>\r\n\r\n            <!-- Email -->\r\n            <div class=\"md-form\">\r\n              <input mdbValidate [validateSuccess]=\"false\" type=\"email\" id=\"email\" class=\"form-control\" formControlName=\"email\" mdbInput>\r\n              <label for=\"email\">E-mail</label>\r\n              <mdb-error *ngIf=\"email && email.invalid && (email.dirty || email.touched)\">Um e-mail válido é obrigatório. Por favor, verifique.</mdb-error>\r\n            </div>\r\n\r\n            <!-- Password -->\r\n            <div class=\"md-form\">\r\n              <input mdbValidate [validateSuccess]=\"false\" type=\"password\" id=\"password\" class=\"form-control\" formControlName=\"password\" mdbInput>\r\n              <label for=\"password\">Senha</label>\r\n              <mdb-error *ngIf=\"password && password.invalid && password.errors && password.errors.required && (password.dirty || password.touched)\">Um e-mail válido é obrigatório. Por favor, verifique.</mdb-error>\r\n              <mdb-error *ngIf=\"password && password.invalid && password.errors && password.errors.minlength && (password.dirty || password.touched)\">A senha deve possuir 6 caracteres ou mais.</mdb-error>\r\n            </div>\r\n\r\n            <!-- Sign in button -->\r\n            <button mdbBtn color=\"primary\" block=\"true\" class=\"my-4 waves-effect z-depth-0\"\r\n              mdbWavesEffect type=\"submit\" (click)=\"onRegister()\">Cadastrar</button>\r\n\r\n            <!-- Register -->\r\n            <p>Já possui uma conta?\r\n              <a routerLink=\"/entrar\">Entrar</a>\r\n            </p>\r\n\r\n          </form>\r\n          <!-- Form -->\r\n\r\n        </mdb-card-body>\r\n\r\n      </mdb-card>\r\n      <!-- Material form login -->\r\n    </div>\r\n  </div>\r\n</div>\r\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/core/dashboard/dashboard.component.html":
/*!***********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/core/dashboard/dashboard.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "<!--Navbar-->\r\n<mdb-navbar #navbar SideClass=\"navbar navbar-expand-lg navbar-light white justify-content-between\" [containerInside]=\"false\">\r\n\r\n  <!-- Navbar brand -->\r\n  <mdb-navbar-brand>\r\n      <a class=\"navbar-brand\" routerLink=\"/\">\r\n          Glassify\r\n      </a>\r\n  </mdb-navbar-brand>\r\n\r\n  <!-- Collapsible content -->\r\n  <links>\r\n\r\n    <!-- Links -->\r\n    <ul class=\"navbar-nav mr-auto\">\r\n      <li *ngIf=\"isLoggedIn && !isLoading\" class=\"nav-item\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/\" routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{exact: true}\" mdbWavesEffect>Home<span class=\"sr-only\">(current)</span></a>\r\n      </li>\r\n      <li *ngIf=\"isLoggedIn && !isLoading\" class=\"nav-item\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/projetos\" routerLinkActive=\"active\" mdbWavesEffect>Projetos</a>\r\n      </li>\r\n      <!-- <li *ngIf=\"isLoggedIn && !isLoading\" class=\"nav-item\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/customers\" routerLinkActive=\"active\" mdbWavesEffect>Tabelas</a>\r\n      </li>\r\n      <li *ngIf=\"isLoggedIn && !isLoading\" class=\"nav-item\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/charts\" routerLinkActive=\"active\" mdbWavesEffect>Gráficos</a>\r\n      </li>\r\n      <li *ngIf=\"isLoggedIn && !isLoading\" class=\"nav-item\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/profile\" routerLinkActive=\"active\" mdbWavesEffect>Perfil</a>\r\n      </li> -->\r\n      <li *ngIf=\"isLoggedIn && !isLoading\" class=\"nav-item\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/app\" routerLinkActive=\"active\" mdbWavesEffect>Calculadora - Teste</a>\r\n      </li>\r\n      <li *ngIf=\"isLoggedIn && !isLoading && isAdmin\" class=\"nav-item\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/admin-panel\" routerLinkActive=\"active\" mdbWavesEffect>Admin</a>\r\n      </li>\r\n    </ul>\r\n    <!-- Links -->\r\n\r\n    <!-- Search form -->\r\n    <ul class=\"navbar-nav\" *ngIf=\"!isLoggedIn && !isLoading\">\r\n      <li class=\"nav-item waves-light\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/entrar\" mdbWavesEffect>Entrar</a>\r\n      </li>\r\n      <li class=\"nav-item waves-light\">\r\n        <a (click)=\"navbar.hide()\" class=\"nav-link waves-light\" routerLink=\"/cadastrar\" mdbWavesEffect>Cadastrar</a>\r\n      </li>\r\n    </ul>\r\n\r\n    <ul class=\"navbar-nav\" *ngIf=\"isLoggedIn && !isLoading\">\r\n      <li class=\"nav-link waves-light dropdown avatar p-0 avatar-dropdown\" mdbDropdown>\r\n        <a mdbDropdownToggle mdbWavesEffect type=\"button\" class=\"nav-link waves-light\" mdbWavesEffect>\r\n          <img *ngIf=\"user.photoUrl\" src=\"{{ user.photoUrl }}\" height=\"35\" width=\"35\" class=\"rounded-circle z-depth-0\" alt=\"avatar image\">\r\n        </a>\r\n          <div *dropdownMenu class=\"dropdown-menu dropdown-menu-right dropdown-primary\" role=\"menu\">\r\n              <div *ngIf=\"user.displayName\" class=\"text-center py-2 px-2\">{{ user.displayName }}</div>\r\n              <div *ngIf=\"!user.displayName\" class=\"text-center py-2 px-2\">Usuário anômino</div>\r\n              <div class=\"divider dropdown-divider\"></div>\r\n              <a class=\"dropdown-item text-center waves-light\" mdbWavesEffect (click)=\"onLogout(); navbar.hide()\">Sair</a>\r\n          </div>\r\n      </li>\r\n      <li class=\"nav-item waves-light logout-button\">\r\n        <a class=\"nav-link waves-light\" mdbWavesEffect (click)=\"onLogout(); navbar.hide()\">Sair</a>\r\n      </li>\r\n    </ul>\r\n  </links>\r\n  <!-- Collapsible content -->\r\n\r\n</mdb-navbar>\r\n<!--/.Navbar-->\r\n"
...
/***/ "./node_modules/raw-loader/index.js!./src/app/core/welcome/welcome.component.html":
/*!*******************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/core/welcome/welcome.component.html ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"container full-page-container\">\r\n  <div class=\"row h-100 justify-content-center align-items-center\">\r\n    <div class=\"col-md-8 text-center fadeIn animated\">\r\n      <h1 class=\"app-heading mb-4\">Glassify</h1>\r\n      <a mdbBtn color=\"primary\" size=\"lg\" class=\"mb-2\" routerLink=\"/cadastrar\">Cadastrar</a>\r\n      <p>\r\n        <small>Já possui cadastro?\r\n          <a routerLink=\"/entrar\">Entrar</a></small>\r\n      </p>\r\n    </div>\r\n  </div>\r\n</div>"
...
/***/ "./node_modules/raw-loader/index.js!./src/app/shared/components/customers-list/customers-list.component.html":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/components/customers-list/customers-list.component.html ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/shared/components/customers-modal/customers-modal.component.html":
/*!************************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/components/customers-modal/customers-modal.component.html ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/shared/components/project-modal/project-modal.component.html":
/*!********************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/components/project-modal/project-modal.component.html ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/shared/components/project/project.component.html":
/*!********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/components/project/project.component.html ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<mdb-card>\r\n  <!--Card image-->\r\n  <mdb-card-img *ngIf=\"project.photoUrl\" src=\"{{ project.photoUrl }}\" alt=\"Card image cap\" class=\"waves-light\"\r\n    mdbWavesEffect></mdb-card-img>\r\n  <!-- <mdb-card-img *ngIf=\"!project.photoUrl\" src=\"https://mdbootstrap.com/img/Photos/Lightbox/Thumbnail/img%20(97).jpg\" alt=\"Card image cap\"></mdb-card-img> -->\r\n  <!--Card content-->\r\n  <mdb-card-body>\r\n\r\n    <!--Title-->\r\n    <mdb-card-title>\r\n      <h4>{{ project.title }}</h4>\r\n    </mdb-card-title>\r\n\r\n    <!--Text-->\r\n    <mdb-card-text> {{ project.description }}\r\n    </mdb-card-text>\r\n\r\n    <div class=\"text-left\">\r\n      <a *ngIf=\"editable\" mdbBtn color=\"primary\" mdbWavesEffect (click)=\"onEdit()\">Editar</a>\r\n      <a mdbBtn class=\"red lighten-1 white-text\" mdbWavesEffect (click)=\"onDelete()\">Apagar</a>\r\n    </div>\r\n  </mdb-card-body>\r\n</mdb-card>"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/shared/components/projects-list/projects-list.component.html":
/*!********************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/components/projects-list/projects-list.component.html ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = ".back-button {\n  cursor: pointer;\n  font-size: 1.8rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var UserDetailComponent = /** @class */ (function () {
    ...
    UserDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./user-detail.component.html */ "./node_modules/raw-loader/index.js!./src/app/admin/components/user-detail/user-detail.component.html"),
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-user',
            template: __webpack_require__(/*! raw-loader!./user.component.html */ "./node_modules/raw-loader/index.js!./src/app/admin/components/user/user.component.html"),
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectionStrategy"].OnPush,
...
module.exports = ".users-list {\n  box-sizing: border-box;\n  justify-content: center;\n}\n\n.user {\n  width: 80%;\n  margin: 1rem;\n}\n\n@media (min-width: 768px) {\n  .user {\n    width: calc(50% - 2rem);\n  }\n\n  .users-list {\n    justify-content: normal;\n  }\n}\n\n@media (min-width: 992px) {\n  .user {\n    width: calc(33.3333% - 2rem);\n  }\n}\n\n@media (min-width: 1200px) {\n  .user {\n    width: calc(25% - 3rem);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var UsersListComponent = /** @class */ (function () {
    ...
    UsersListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./users-list.component.html */ "./node_modules/raw-loader/index.js!./src/app/admin/components/users-list/users-list.component.html"),
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectionStrategy"].OnPush,
...
var AdminComponent = /** @class */ (function () {
    ...
    AdminComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-admin',
            template: __webpack_require__(/*! raw-loader!./admin.component.html */ "./node_modules/raw-loader/index.js!./src/app/admin/containers/admin/admin.component.html"),
...
var routes = [
    { path: '', component: _core_home_home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"], children: [
            ...
            { path: 'projetos', loadChildren: './projects/projects.module#ProjectsModule', canActivate: [_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
            { path: 'app', loadChildren: './customers/customers.module#CustomersModule', canActivate: [_auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
    ...
    { path: 'cadastrar', component: _auth_components_register_register_component__WEBPACK_IMPORTED_MODULE_2__["RegisterComponent"] },
    { path: 'entrar', component: _auth_components_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"] },
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./dashboard.component.html */ "./node_modules/raw-loader/index.js!./src/app/core/dashboard/dashboard.component.html"),
...
module.exports = ".nav-link.active {\n  background-color: #eee;\n}\n\n.logout-button {\n  display: none;\n}\n\n.avatar-dropdown {\n  display: block;\n}\n\n@media (max-width: 992px) {\n  .avatar-dropdown {\n    display: none;\n  }\n\n  .logout-button {\n    display: block;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-main',
            template: __webpack_require__(/*! raw-loader!./main.component.html */ "./node_modules/raw-loader/index.js!./src/app/core/main/main.component.html"),
...
module.exports = ".row {\n  margin: 0;\n  position: absolute;\n  top: 50%;\n  left: 55%;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n}\n\n.full {\n  min-height: 40rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".app-heading {\n  font-size: 3.5rem;\n  font-weight: 100;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var WelcomeComponent = /** @class */ (function () {
    ...
    WelcomeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./welcome.component.html */ "./node_modules/raw-loader/index.js!./src/app/core/welcome/welcome.component.html"),
...
var CustomersListComponent = /** @class */ (function () {
    ...
    CustomersListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./customers-list.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/components/customers-list/customers-list.component.html"),
...
var CustomersModalComponent = /** @class */ (function () {
    ...
    CustomersModalComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./customers-modal.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/components/customers-modal/customers-modal.component.html"),
...
var ProjectModalComponent = /** @class */ (function () {
    ...
    ProjectModalComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./project-modal.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/components/project-modal/project-modal.component.html"),
...
var ProjectComponent = /** @class */ (function () {
    ...
    ProjectComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./project.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/components/project/project.component.html"),
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectionStrategy"].OnPush,
...
module.exports = ".projects-list {\n  box-sizing: border-box;\n  justify-content: center;\n}\n\n.project {\n  width: 80%;\n  margin: 1rem;\n}\n\n@media (min-width: 768px) {\n  .project {\n    width: calc(50% - 2rem);\n  }\n\n  .projects-list {\n    justify-content: normal;\n  }\n}\n\n@media (min-width: 992px) {\n  .project {\n    width: calc(33.3333% - 2rem);\n  }\n}\n\n@media (min-width: 1200px) {\n  .project {\n    width: calc(25% - 3rem);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ProjectsListComponent = /** @class */ (function () {
    ...
    ProjectsListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./projects-list.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/components/projects-list/projects-list.component.html"),
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectionStrategy"].OnPush,
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyB49Bca6GD08PCXhOXexuACgXyuyX3cVGI",
        authDomain: "glassify-br.firebaseapp.com",
        databaseURL: "https://glassify-br.firebaseio.com",
        projectId: "glassify-br",
        storageBucket: "glassify-br.appspot.com",
        messagingSenderId: "1083751729442",
        appId: "1:1083751729442:web:d8bf8622587709cc827d7b",
        measurementId: "G-QQLKKXDJNJ"
    }
};
/*
...
module.exports = __webpack_require__(/*! D:\Std\__W\glassify-admin\src\main.ts */"./src/main.ts");
