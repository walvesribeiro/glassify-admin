...
export class GeometriaComponent implements OnInit, OnChanges {
  ...
  buildForm() {
    this.geometriaForm = new FormGroup({
      ...
      TipoTratamento: new FormControl()
    });
  }
  ...
  buildCalculo() {
    this.geometriaForm = new FormGroup({
      ...
      TipoPavimento: new FormControl(sessionStorage.getItem('TipoPavimento')),
      TipoTratamento: new FormControl(sessionStorage.getItem('TipoPavimento')),
    });
  }
  ...
  forma(geo: any) {
    const type: any = {
        ...
        'triretangulo': () => Number(this.Altura) * Number(2 / 3), // ok
        'trapezio': () => Number(this.geometriaForm.controls.AlturaC) + Number(2 / 3) * (Number(this.Altura) -
          Number(this.geometriaForm.controls.AlturaC.value)),
        'circular': () => Number(0.85) * Number(this.Altura), // ok
