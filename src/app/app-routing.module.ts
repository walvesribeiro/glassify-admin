...
const routes: Routes = [
  { path: '', component: HomeComponent, children: [
    ...
    { path: 'projetos', loadChildren: './projects/projects.module#ProjectsModule', canActivate: [AuthGuard]},
    { path: 'app', loadChildren: './customers/customers.module#CustomersModule', canActivate: [AuthGuard]},
